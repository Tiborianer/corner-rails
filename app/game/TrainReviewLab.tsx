    ...
    <main className={`railjet-lab-shell ${initialState.captureMode ? "capture-mode" : ""}`}>
      ...
      {!initialState.captureMode && (
        <aside className="railjet-lab-controls" aria-label="Train review controls">
          ...
          {candidate.supportsCabCarLeading && <SegmentedControl label="Leading end" value={leadingEnd} options={[{ value: "taurus", label: candidate.locomotiveLabel ?? "Locomotive" }, { value: "cab-car", label: "Cab car" }]} onChange={setLeadingEnd} />}
