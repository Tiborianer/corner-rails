...
export const TRAIN_REVIEW_CANDIDATES = {
  ...
  "railjet-nextgen-livery-v2": {
    ...
    assetRevision: "livery-v2-3",
    vehicleCount: 10,
    nominalLengthMeters: 258,
    reviewPlatformLengthMeters: 280,
    traction: "electric",
    revision: "livery-review-2.2",
    ...
    approvalStatus: "private-review",
    reviewStage: "formation",
    reviewSummary: "Livery-only review candidate preserves the approved Viaggio Next Level geometry and applies its distinct wine-red upper body, graphite lower body, bright-red belt and cab sweep, aluminium skirts and pale door surrounds. V2.2 rebuilds the passenger-car sides as non-overlapping colour bands so the graphite surface cannot cover the thicker red belt or aluminium skirt. Production remains unchanged pending approval.",
