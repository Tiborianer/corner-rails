...
export const TRAIN_REVIEW_CANDIDATES = {
  ...
  "railjet-nextgen-livery-v2": {
    ...
    approvalStatus: "private-review",
    reviewStage: "formation",
    reviewSummary: "Livery-only review candidate preserves the approved Viaggio Next Level geometry and applies its distinct wine-red upper body, graphite lower body, bright-red belt and cab sweep, aluminium skirts and pale door surrounds. Production remains unchanged pending approval.",
