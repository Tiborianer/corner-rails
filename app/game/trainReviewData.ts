...
export const TRAIN_REVIEW_CANDIDATES = {
  ...
  "railjet-nextgen-livery-v2": {
    ...
    approvalStatus: "private-review",
    reviewStage: "formation",
    reviewSummary: "Livery-only review candidate preserves the approved Viaggio Next Level passenger cars. V2.3 rebuilds only the Taurus: two trapezoidal windscreen panes now follow one curved black visor on the nose surface, the swept side cab glass follows the tapered shell, the former fake window-like vent row is removed, and the livery uses a broad level bright-red belt with cab wraps. Production remains unchanged pending approval.",
