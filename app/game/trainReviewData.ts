...
export const TRAIN_REVIEW_CANDIDATES = {
  "db-regional-express-r3": {
    ...
    shortLabel: "Regional-Express R3", assetPath: "/models/train-lab/db-regional-express-r3/db-regional-express-r3.glb",
    ...
    productionTrainId: "db-regional-express", approvalStatus: "private-review", reviewStage: "formation",
    reviewSummary: "R3: rounded roof shoulders, body-following upper windows, white double doors and a newly shaped driving trailer. The approved BR 245 is retained. Appearance approval is required before replacing the game’s R2 set.",
  ...
  "db-regional-express": {
    ...
    approvalStatus: "approved-production",
    reviewStage: "formation",
    reviewSummary: "Approved production R2 BR 245 double-deck Regional-Express. The shaped diesel locomotive, two coaches and driving trailer shown here are the same metric formation used by the Tier 2 service.",
