...
export default async function Home({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  if (trainLab === "railjet-classic-livery-v2" || trainLab === "railjet-nextgen-livery-v2" || trainLab === "db-regional-express" || trainLab === "nightjet-new-generation" || trainLab === "ice3-br403" || trainLab === "ice3-br403-v2" || trainLab === "ice3-br403-v2-continuity" || trainLab === "ice3-br403-v2-unified") {
