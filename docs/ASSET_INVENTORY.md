...
| Railjet livery review V2 | Private classic and new-generation Railjet recolour candidates with wine-red upper body, bright-red belt, graphite lower flank, aluminium skirt and generation-specific door/window treatment. New-generation V2.2 fixes passenger-car material assignment; V2.3 preserves those cars and rebuilds only the Taurus with surface-conforming front/side cab glazing, authentic shoulder grilles, paired light housings and a broad level belt wrapping onto both cabs | `assets/blender/railjet-*-livery-v2/`, `public/models/train-lab/railjet-*-livery-v2/` |
