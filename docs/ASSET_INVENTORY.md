...
| Railjet livery review V2 | Private classic and new-generation Railjet recolour candidates with authentic wine-red upper body, bright-red belt, graphite lower flank, aluminium skirt and generation-specific door/window treatment; new-generation V2.2 fixes per-object Blender materials and uses non-overlapping side bands so black geometry cannot obscure the red or aluminium sections | `assets/blender/railjet-*-livery-v2/`, `public/models/train-lab/railjet-*-livery-v2/` |
