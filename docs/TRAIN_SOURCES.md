...
- **Tier 5:** Railjet now uses the approved Blender classic and new-generation formations. The classic has a Taurus locomotive, seven dedicated coaches and a driving trailer; the new generation has a locomotive and nine Viaggio Next Level vehicles with visibly lower entrances. Nightjet, TGV Euroduplex, RegioJet, Giruno and ComfortJet remain temporary legacy assets pending individual Blender review and approval.
